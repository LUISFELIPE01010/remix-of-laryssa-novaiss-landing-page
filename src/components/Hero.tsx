...
const Hero = () => {
  ...
  return <section className="min-h-screen flex flex-col bg-gradient-to-br from-white to-nude-soft">
      {/* Header with Logo */}
      <header className="w-full py-6 px-4">
        <div className="max-w-6xl mx-auto flex justify-center lg:justify-start">
          <img src="/lovable-uploads/logo-karine-keppler.png" alt="Karine Keppler Nutricionista" className="h-16 md:h-20 object-contain" />
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-in-right">
            <div className="relative">
              ...
              <img alt="Karine Keppler, nutricionista sorrindo em ambiente acolhedor" className="relative rounded-3xl shadow-2xl w-full max-w-md mx-auto object-cover h-[500px] md:h-[600px]" loading="eager" src="/lovable-uploads/96ec3a97-00b4-4ae7-8745-05c507404d9f.jpg" />
            </div>
          </div>
        </div>
      </div>
