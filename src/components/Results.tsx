...
const Results = () => {
  ...
  const resultItems = [
    ...
    },
    {
      ...
      name: 'Carla, 35 anos',
      feedback:
        'Aprendi a comer sem medo e sem culpa. A nutrição comportamental mudou minha vida.',
    },
    {
      ...
      feedback:
        'Descobri quais alimentos me faziam mal e hoje tenho um cardápio variado e sem sintomas.',
    },
    {
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-14 animate-on-scroll">
            ...
            <p className="text-lg text-gray-rose/80 max-w-3xl mx-auto">
              Cada transformação é única. Veja como a nutrição individualizada e o cuidado com a saúde intestinal transformaram a vida dessas pacientes.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14 animate-on-scroll">
            {resultItems.map((item, index) => (
              <article
                key={index}
                className="bg-white rounded-3xl border border-chrome-light/20 shadow-lg overflow-hidden hover-lift"
              >
                <img
                  src={item.image}
                  alt={item.alt}
